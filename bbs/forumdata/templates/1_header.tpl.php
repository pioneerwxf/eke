...
<title><?=$navtitle?> <?=$bbname?> <?=$seotitle?> - Powered by Wangxianfeng!</title>
<?=$seohead?>
...
<body onkeydown="if(event.keyCode==27) return false;">
	...
	<div class="wrap">
		...
		<? } ?>
			...
			<ul><li><a href="../front/index.php" target="_top"><img src="images/common/back.gif" border="0" /><span style="color:#FF6600;">回eKe网站首页</span></a></li>
			<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
			<? if($discuz_uid) { ?>
				<li><cite><a href="space.php?action=viewpro&amp;uid=<?=$discuz_uid?>"><?=$discuz_userss?></a></cite></li>
				<li><a href="<?=$link_logout?>" class="notabs">退出</a></li>
				<? if($maxpmnum) { ?><li<? if($BASESCRIPT == 'pm.php') { ?> class="current"<? } ?>><a href="pm.php">短消息</a></li><? } ?>
			<? } else { ?>
				<li<? if($BASESCRIPT == $regname) { ?> class="current"<? } ?>><a href="<?=$link_register?>" class="notabs" target="_blank"><?=$reglinkname?></a></li>
